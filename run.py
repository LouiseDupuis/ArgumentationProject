...
from ArgumentationProject.learning import learn_all, learn_confirmation_bias, learn_nothing
from ArgumentationProject.voting import simple_voting_heuristic_opinion, upvote_all, simple_voting_heuristic
import pandas as pd 
...
def run_debate():
    ...
    return debate_model, game_stats
